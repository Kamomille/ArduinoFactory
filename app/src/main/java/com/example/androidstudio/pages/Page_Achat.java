...
public class Page_Achat extends AppCompatActivity {
    ...
    // Définition de tout les bouton dans la page
    ...
    private ImageView Bouton_poussoir;
    private ImageView Capteur_distance;
